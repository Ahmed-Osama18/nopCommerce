...
public class P03_homePage {
    ...
    public WebElement apparel_Locator(WebDriver driver)
    {
        return driver.findElement(By.xpath("//ul[@class=\"top-menu notmobile\"]/li/a[@href=\"/apparel\"]"));
    }

    public WebElement shoes_Locator(WebDriver driver)
    {
        return driver.findElement(By.xpath("//ul[@class=\"top-menu notmobile\"]/li/ul/li/a[@href=\"/shoes\"]"));
    }

    public WebElement RedShoes_Checkbox(WebDriver driver)
    {
        return driver.findElement(By.id("attribute-option-15"));
    }

    public WebElement awesomeTagLocator(WebDriver driver)
    {
        return driver.findElement(By.xpath("//div[@class=\"tags\"]/ul/li/a[@href=\"/awesome\"]"));
    }

    public String getTagTitle(WebDriver driver)
    {
        return driver.findElement(By.xpath("//div[@class=\"page-title\"]/h1")).getText();
    }
    ...
    public WebElement compareBTN(WebDriver driver)
    {
    ...
    {
        return driver.findElement(By.xpath("//div[@id=\"bar-notification\"]//a[@href=\"/cart\"]"));
    }

    public WebElement acceptTerms(WebDriver driver)
    {
